...
HTML;
    ...
    public function getBaseTagWithFormData()
    {
        return array(
            ...
            array('/basepath', '/auth', 'http://domain.com/auth', 'http://domain.com/auth', '<base> tag does work with a path and form action'),
            array('/basepath', '', 'http://domain.com/auth', 'http://domain.com/auth', '<base> tag does work with a path and empty form action'),
            array('http://base.com/', '/auth', 'http://base.com/auth', 'http://domain.com/auth', '<base> tag does work with a URL and form action'),
            ...
            array('http://base.com/path', '/auth', 'http://base.com/auth', 'http://domain.com/path/form', '<base> tag does work with a URL and form action'),
        );
    }
